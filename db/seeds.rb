...
Post.create(author: user, title: 'Hello1', text: 'This is my first post', commentsCounter: 0, likesCounter: 0)
Post.create(author: user, title: 'Hello2', text: 'This is my second post', commentsCounter: 0, likesCounter: 0)
Post.create(author: user, title: 'Hello3', text: 'This is my third post', commentsCounter: 0, likesCounter: 0)
Post.create(author: user, title: 'Hello4', text: 'This is the fourth post', commentsCounter: 0, likesCounter: 0)
